...
struct qt_meta_stringdata_CLASSfeedbackENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSfeedbackENDCLASS = QtMocHelpers::stringData(
    "feedback",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSfeedbackENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject feedback::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSfeedbackENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSfeedbackENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSfeedbackENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *feedback::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSfeedbackENDCLASS.stringdata0))
